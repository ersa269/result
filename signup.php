...
$query=mysqli_query($con,"insert into users(Name,Email,Pass,Role) values('$name','$email','$pass','$role')");
				...
				<div class="col-lg-6">
					<div class="login_form_inner">
						...
						<form class="row login_form"  method="post" id="contactForm" novalidate="novalidate">
							...
							<div class="col-md-12 form-group">
							<select class="form-control input-box" name="role">
                                                        <?php
                                                        if($role1=="admin"){
                                                        ?>
                                                        <option class="shah" value="employee">Employee</option>

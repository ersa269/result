                ...
                <div class="sidebar-content">
                    ...
                    <div class="content-side content-side-full">
                        <ul class="nav-main">
                            ...
                            <li>
                                <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-puzzle"></i><span class="sidebar-mini-hide">Employee</span></a>
                                <ul>
                            ...
                            <li>
                                <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-moustache"></i><span class="sidebar-mini-hide">Teacher</span></a>
                                <ul>
                            ...
                            <li>
                                <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-energy"></i><span class="sidebar-mini-hide">Parent</span></a>
                                <ul>
                                    <li>
                                        <a href="final.php">Result</a>
                                    </li>
                                    <li>
                            ...
                            <li>
                                <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-layers"></i><span class="sidebar-mini-hide">Student</span></a>
                                <ul>
                                    <li>
                                        <a href="final.php">Result</a>
                                    </li>
                                    <li>
                                        <a href="std_login.php">Login</a>
                                    </li>

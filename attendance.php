...
$query=mysqli_query($con,"insert into attendance(StudentName,StudentEnroll,Date,Attendance) 
values('$name','$enroll','$date','$atten')");
}
?>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="block">
                                <div class="block-header block-header-default">
                                    <h3 class="block-title">Student Record</h3>
                                ...
                                <div class="block-content">
                                    <form method="post">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-12">Attendance</label>
                                            <div class="col-md-9">
                                              <select class="form-control input-box" name="atten">
